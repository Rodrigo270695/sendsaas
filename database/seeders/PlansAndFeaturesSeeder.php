...
class PlansAndFeaturesSeeder extends Seeder
{
    public function run(): void
    {
        $definitions = [
            ...
            'starter' => [
                'nombre' => 'Starter',
                'descripcion' => 'Un número OpenWA, 2 usuarios y 500 mensajes salientes por día.',
                'badge' => null,
                'color_hex' => '#AB3C3D',
                'precio_mensual' => 49,
                'trial_days' => 14,
            ...
            'enterprise' => [
                'nombre' => 'Enterprise',
                'descripcion' => 'Usuarios, sesiones OpenWA y mensajes ilimitados. Soporte prioritario.',
                'badge' => null,
                'color_hex' => '#0F6E56',
                'precio_mensual' => 399,
                'trial_days' => 7,
    ...
    private static function limits(
        ...
        return [
            ...
            ['feature' => 'max_outbound_per_month', 'valor_int' => $month, 'valor_bool' => null, 'valor_str' => null],
