...
export default function Security(props: Props) {
    ...
    return (
        <>
            <Head title={t('security.head')} />

            <h1 className="sr-only">{t('security.head')}</h1>
                        ...
                        <>
                            <div className="grid gap-2">
                                ...
                                <PasswordInput
                                    ...
                                    placeholder={t('auth:fields.current_password')}
                                />
                            ...
                            <div className="grid gap-2">
                                <Label htmlFor="password">{t('auth:fields.new_password')}</Label>
