...
> = {
    max_contacts: Users,
    max_usuarios: UserCog,
    max_whatsapp_sessions: Smartphone,
    max_sedes: Building2,
    max_campaigns: Send,
    max_automations: Repeat,
};
                        ...
                        >
                            <div className="flex items-start justify-between gap-2">
                                <div className="flex min-w-0 items-center gap-2">
                                    <div className="flex size-8 shrink-0 items-center justify-center rounded-lg bg-brand-50 text-brand-700 dark:bg-brand-950/40 dark:text-brand-200">
