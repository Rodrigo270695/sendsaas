        ...
        () => ({
            ...
            groups: [
                ...
                },
                {
                    ...
                    items: [
                        {
                            title: t('items.sesiones_whatsapp'),
                            href: '/comunicaciones/sesiones',
                            icon: Smartphone,
                            permission: 'whatsapp.view',
                        },
                        {
                            title: t('items.envios_programados'),
                            href: '/comunicaciones/envios',
                            icon: SendHorizontal,
                            permission: 'comunicaciones.envios.view',
                        },
                        {
                            title: t('items.historial_envios'),
                            href: '/comunicaciones/historial',
                            icon: History,
                            permission: 'comunicaciones.historial.view',
                        },
                    ],
                },
                {
